...
def calculate(C, w, G):
    ...
    if F > 100:
        ...
        print("But, you can get a " + str(round(G1,2)) + " if you get 100 on exam. Or you could get a " + str(round(G2,2)) + " if you get 90 on the exam.")



    else:
        print("In order to get a " + str(target_grade).capitalize() + " you would need to get a " + str(round(F,2)) + " on the exam. Good luck!")
...
while True:
    ...
    try:
        ...
        print("You must input an integer. With or without a decimal point.")
    else:
        break
...
while True:
    ...
    if target_grade in letter_grades:
        ...
        # print(number_target_grade)
        break
    else:
        print("This is not a possible letter grade. ")
        continue
